# -*- coding: utf-8 -*-
"""
Created on Sat Nov 12 01:44:47 2022
...
def state_purity(angle, phase, circuit_param, noise_param):
    ...
    reducedRho = noisy_circuit(angle, phase, circuit_param, noise_param)
     
    # Return the purity in terms of the calculated expectation values.
    return np.trace(np.matmul(reducedRho,reducedRho)) 
