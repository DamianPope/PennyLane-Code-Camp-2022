# -*- coding: utf-8 -*-
"""
Created on Mon Nov 14 00:05:11 2022
...
def shifts_and_coeffs():
    ...
    """
    shifts = [math.pi/2,math.pi]
    coeffs = [0.5,(2**0.5-1)/4]
...
def my_parameter_shift_grad(params):
    ...
    for i in range(len(params)):
        ...
        params[i]-=2*shifts[0]
        minus = circuit(params)

        #reset value of params[i] to initial value
        params[i]+=shifts[0]

        gradient[i]=coeffs[0]*(plus-minus)
        ...
        gradient[i]-=coeffs[1]*(plus-minus)
